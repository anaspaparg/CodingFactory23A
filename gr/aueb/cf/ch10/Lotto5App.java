...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("/Users/anastasiospapargyropoulos/Documents/Java/tmp/us copy.txt"));
             PrintStream ps = new PrintStream("/Users/anastasiospapargyropoulos/Documents/Java/us copy1.txt", StandardCharsets.UTF_8)) {
     ...
     * @return          true if the number of evens is greater
